...
export class MealOptionsComponent implements OnInit, OnChanges {
    ...
    onResize(event: any) {
        ...
        svg.select<SVGGElement>('#options-x-axis')
            .transition()
        ...
        svg.select<SVGGElement>('#options-y-axis')
            .transition()
            .ease(d3.easePolyInOut)
            .duration(500)
        ...
        svg.selectAll('.options-filtered')
            .data(this.data.filter)
            .join()
            .transition()
            .ease(d3.easePolyInOut)
    ...
    drawChart(data) {
        ...
        contentGroup
            .selectAll('.options-filtered')
            .data(data)
            .enter()
            .append('circle')
            .attr('class', 'options-filtered')
    ...
    updateChart(data) {
        const contentGroup = d3.select('#mealOptions');
