...
export class OperationsComponent implements OnInit, OnChanges {
    ...
    onResize(event: any) {
        ...
        svg.select<SVGGElement>('#ops-x-axis')
            .transition()
        ...
        svg.select<SVGGElement>('#ops-y-axis')
            .transition()
            .ease(d3.easePolyInOut)
            .duration(500)
    ...
    drawChart(data) {
        ...
        d3.selectAll('#ops-x-axis')
            .selectAll('text')
            .attr('text-anchor', 'start')
            .attr('dx', 5);
        d3.selectAll('#ops-x-axis .tick line')
            .attr('stroke', '#5B6771')
            .attr('stroke-width', 0.5)
            .attr('y1', 15);
        d3.selectAll('#ops-y-axis .tick line')
            .attr('stroke', '#CCC')
    ...
    updateChart(data) {
        const contentGroup = d3.select('#programChallenges');
