...
@Component({
    selector: 'app-financial-challenges',
    templateUrl: './financial-challenges.component.html',
    styleUrls: ['./financial-challenges.component.scss'],
})
export class FinancialChallengesComponent implements OnInit, OnChanges {
    ...
    onResize(event: any) {
        ...
        svg.select<SVGGElement>('#fin-x-axis')
            .transition()
        ...
        svg.select<SVGGElement>('#fin-y-axis')
            .transition()
            .ease(d3.easePolyInOut)
            .duration(500)
    ...
    drawChart(data) {
        ...
        contentGroup
            .selectAll('.fin-filtered')
            .data(data)
            .enter()
            .append('circle')
            .attr('class', 'fin-filtered')
    ...
    updateChart(data) {
        const contentGroup = d3.select('#financialChallenges');
