...
export class DeliveryMethodsComponent implements OnInit, OnChanges {
    ...
    onResize(event: any) {
        ...
        svg.select<SVGGElement>('#delivery-x-axis')
            .transition()
        ...
        svg.select<SVGGElement>('#delivery-y-axis')
            .transition()
            .ease(d3.easePolyInOut)
            .duration(500)
        ...
        svg.selectAll('.delivery-filtered')
            .data(this.data.filter)
            .join()
            .transition()
            .ease(d3.easePolyInOut)
    ...
    ngOnInit(): void {
        this.http
            .get('../../assets/data/delivery-methods-full.csv', {
                responseType: 'text',
            })
            .subscribe((data) => {
    ...
    drawChart(data) {
        ...
        contentGroup
            .selectAll('.delivery-filtered')
            .data(data)
            .enter()
            .append('circle')
            .attr('class', 'delivery-filtered')
        ...
        d3.selectAll('.delivery-filtered')
    ...
    updateChart(data) {
        const contentGroup = d3.select('#mealDelivery');
